...
| V0.3.x Korean Foundation | model baseline, eval harness | Korean STT/LLM/TTS adapters | baseline accepted | Korean gains with English/agentic non-regression |
| V0.4.x Persona and Agentic | Korean adapters, persona corpus | persona/agentic branch comparison | hard/vector evaluator ready | selected branch passes persona/tool gates |
| V0.5.x Static Miku Voice | speech corpus, TTS baseline | stable static speaker adapter/emotions | rights and effective hours accepted | similarity/naturalness/timbre/intelligibility gates |
| V0.6.x Integrated VoiceChat | promoted components | joint streaming runtime | component gates pass | TTFA/interruption/soak and regression gates |
| V0.7.x Backend, Memory, Codex, Scheduler | protocol and runtime | policy-enforced server services | threat controls testable | auth/memory/tool/scheduler integration and safety gates |
